...
2. On your computer, clone the [https://github.com/Code-the-Dream-School/python200-homework](https://github.com/Code-the-Dream-School/python_homework) repository. (Do not clone the repository you just created.)
3. Change to the python_homework directory you just cloned. Enter the following commands:

```shell
# if you use ssh authentication:
git remote set-url origin git@github.com:your-github-id/python200-homework.git
# if you use token based authentication:
git remote set-url origin https://github.com/your-github-id/python200-homework

git remote add upstream https://github.com/Code-the-Dream-School/python200-homework
git push origin main
```

4. While still within the python200-homework directory, enter the following commands:
